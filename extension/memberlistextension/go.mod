module github.com/open-telemetry/opentelemetry-collector-contrib/extension/memberlistextension
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/extension/memberlistextension => ./
